...
const CourseContentMedia = ({
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <h1 className="pt-2 text-[25px] dark:text-white text-black font-[600]">
          ...
          <div className="flex w-full">
            <Image
              src={
                user.avatar
                  ? user.avatar.url
                  : "https://res.cloudinary.com/dshp9jnuy/image/upload/v1665822253/avatars/nrxsg@sd91y1@bbsoenn.png"
              }
              width={50}
              height={50}
              alt=""
              className="w-[50px] height-[50px] rounded-full object-cover"
            />
            <textarea
              name=""
              value={question}
              ...
              className="outline-none bg-transparent ml-3 border border-[#ffffff57] 800px:sw-full p-2 rounded w-[90%] 800px:text-[18px] font-Poppins"
            ></textarea>
          </div>
            ...
            {item.questionReplies.map((item: any) => (
              ...
              >
                ...
                <div className="pl-2">
                    ...
                    <h5 className="text-[20px]">{item?.user.name}</h5><VscVerifiedFilled className="text-[#2a2091] ml-2 text-[20px]"/>
                    </div>
                    <p>{item.answer}</p>
                    <small className="dark:text-[#ffffff83] text-[#000000b8]">
            ...
            <>
                    <div className="w-full flex relative dark:text-white text-black">
                        <input
                          ...
                          className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#00000027] dark:text-white text-black dark:border-[#fff] p-[5px] w-[95%] ${answer === "" || answerLoading && 'cursor-not-allowed'}`}
                          />
                          <button
                            type="submit"
...

{
  /* <div className="w-[50px] h-[50px]">
                        <div className="w-[50px] h-[50px] bg-slate-600 rounded-[58px] flex items-center justify-center cursor-pointer">
